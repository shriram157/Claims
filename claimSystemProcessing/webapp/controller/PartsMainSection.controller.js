	...
	return BaseController.extend("zclaimProcessing.controller.PartsMainSection", {
			...
			_fnSaveClaimParts: function (oEvent) {
				...
				if (!oValid && (this.getView().getModel("HeadSetData").getProperty("/ShipmentReceivedDate") == undefined || this.getView().getModel(
							"ShipmentReceivedDate")
						.getProperty("/RepairDate") == "") && (this.getView().getModel("HeadSetData").getProperty("/DeliveryDate") == undefined || this.getView()
						.getModel("HeadSetData") == "") && (this.getView().getModel("HeadSetData").getProperty("/DeliveringCarrier") == "" || this.getView()
						.getModel("HeadSetData").getProperty("/DeliveringCarrier") == undefined))
				...
				this.getView().byId("idMainClaimMessage").setText("Please fill up all mandatory fields.");
				this.getView().byId("idMainClaimMessage").setType("Error");
			} elseif (oValid && this.getView().getModel("HeadSetData").getProperty("/WarrantyClaimType") != undefined && this.getView().getModel(
					"HeadSetData").getProperty("/WarrantyClaimType") != "") {
