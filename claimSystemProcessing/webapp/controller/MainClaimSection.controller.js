			...
			onCopyClaim: function () {
				...
				if (oAuthNum != "" && oAuthNum != undefined) {
					...
					if (oClaimType == "ZAUT" || oClaimType == "ZACD") {
						this.getModel("LocalDataModel").setProperty("/oSavePartIndicator", true);
						oClaimModel.read("/zc_auth_copy_to_claimSet", {
							urlParameters: {
								"$filter": "NumberOfAuth eq '" + oAuthNum + "'and Language eq '" + sSelectedLocale.toUpperCase() + "'"
							},
						...
						this.getModel("LocalDataModel").setProperty("/oSavePartIndicator", true);
						oClaimModel.read("/zc_claim_copy_to_authSet", {
							urlParameters: {
								"$filter": "NumberOfWarrantyClaim eq '" + oAuthNum + "'and Language eq '" + sSelectedLocale.toUpperCase() + "'"
							},
