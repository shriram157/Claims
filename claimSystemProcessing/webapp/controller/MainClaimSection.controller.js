							...
							if (oClaim != "nun" && oClaim != undefined) {
								...
								oProssingModel.read("/ZC_CLAIM_HEAD_NEW", {
									...
									success: $.proxy(function (data) {
										...
										} else if (oClaimTypeDetail == "ZSCR" && data.results[0].ProcessingStatusOfWarrantyClm == "ZTIC") {
								...
								if (oClaimType == "ZAUT" || oClaimType == "ZACD") {
									...
									oClaimModel.read("/zc_auth_copy_to_claimSet(NumberOfAuth='" + oAuthNum + "')", {
										...
										onStep03Next: function () {
											...
											if (this.getView().getModel("HeadSetData").getProperty("/WarrantyClaimType") == "ZWP2" || this.getView().getModel(
													"HeadSetData")
												.getProperty(
										...
										onStep04Next: function () {
											this.oBundle = this.getView().getModel("i18n").getResourceBundle();
											if (this.getView().getModel("HeadSetData").getProperty("/WarrantyClaimType") != "ZWMS" && this.getView().getModel(
													"HeadSetData")
												.getProperty(
													"/WarrantyClaimType") != "ZWA1" && this.getView().getModel("HeadSetData").getProperty("/WarrantyClaimType") != "ZWA2" &&
												this.getView()
												.getModel(
													"HeadSetData").getProperty("/WarrantyClaimType") != "ZWAC" && this.getView().getModel("HeadSetData").getProperty(
													"/WarrantyClaimType") != "ZWP1" &&
												this.getView().getModel("HeadSetData").getProperty("/WarrantyClaimSubType") != "ZWMS" && this.getView().getModel(
													"HeadSetData")
												.getProperty(
										...
										onStep06Next: function () {
											...
											// 	this.getView().byId("idIconTabMainClaim").setSelectedKey("Tab7");
											// }else 
											if (this.getView().getModel("HeadSetData").getProperty("/WarrantyClaimType") != "ZWA1" && this.getView().getModel(
													"HeadSetData")
												.getProperty(
												...
												this.getView().getModel("HeadSetData").getProperty("/WarrantyClaimSubType") != "ZWA1" && this.getView().getModel(
													"HeadSetData")
												.getProperty(
										...
										_handleValueHelpClose: function (evt) {
											...
											oProductModel.read("/ZC_Characteristic_InfoSet", {
												urlParameters: {
													"$filter": "MATERIAL eq '" + this.oSelectedTitle +
														"' and CLASS eq 'WARRANTY_INFO' and CHARAC eq 'Warranty Alternate Unit'"
												},
												success: $.proxy(function (data) {
													if (data.results.length > 0) {
										...
										onSubmitTci: function () {
											...
											this.obj.PreviousROInvoiceDate = this._fnDateFormat(this.getView().getModel("HeadSetData").getProperty(
												"/PreviousROInvoiceDate"));
										...
										onPressPrint: function () {
											...
											} else if (oClaimtype == "CORE RETURN" || oClaimtype == "SMART PARTS" || oClaimtype == "VEHICLE LOGISTICS" ||
