sap.ui.define([
	...
	return {
		...
		_fnUpdateHeaderProp: function (elm) {
			...
			elm.obj.RebateAmount = elm.getView().getModel("HeadSetData").getProperty("/RebateAmount") ? parseFloat(elm.getView().getModel("HeadSetData").getProperty("/RebateAmount")).toFixed(2) : "0.00";
